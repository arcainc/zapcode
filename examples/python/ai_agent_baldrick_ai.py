"""
AI Agent using baldrick-ai — the high-level wrapper.

This is the recommended way to use Baldrick with AI models.
One call to `baldrick()` gives you system prompt + tool definitions
that plug directly into any AI SDK.

Prerequisites:
    pip install baldrick-ai anthropic
    # or: uv add baldrick-ai anthropic
    export ANTHROPIC_API_KEY=sk-ant-...

Run with: python ai_agent_baldrick_ai.py
"""

import anthropic
from baldrick_ai import baldrick, ToolDefinition, ParamDef
